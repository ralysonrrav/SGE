    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button 
          ...
          className="bg-indigo-600 dark:bg-indigo-500 text-white px-6 py-3 rounded-xl font-black hover:bg-indigo-700 dark:hover:bg-indigo-400 transition-all flex items-center justify-center gap-2 shadow-lg dark:shadow-none"
        >
          <Plus size={20} />
          Cadastrar Resultado
        </button>
      ...
      {showAddForm && (
        <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-indigo-100 dark:border-indigo-900/30 shadow-2xl dark:shadow-none animate-in zoom-in-95 duration-200 transition-all relative">
          <button 
          ...
          <div className="flex gap-4 mt-8 pt-6 border-t border-slate-100 dark:border-slate-800">
            <button 
              onClick={addMock}
              className="bg-indigo-600 dark:bg-indigo-500 text-white px-8 py-3 rounded-xl font-black hover:bg-indigo-700 dark:hover:bg-indigo-400 transition-all w-full md:w-auto shadow-lg"
            >
              SALVAR RESULTADO
            </button>
            <button 
